package com.example.yuzhong.my_camera;
...
//PhotoPickerDialogFragment handles all the customized dialog boxes in our project.
...
public class PhotoPickerDialogFragment extends DialogFragment {
	...
	public static final int ID_PHOTO_PICKER_FROM_SD_CARD = 1;

	private static final String DIALOG_ID_KEY = "dialog_id";

	public static PhotoPickerDialogFragment newInstance(int dialog_id) {
		PhotoPickerDialogFragment mFrag = new PhotoPickerDialogFragment();
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		case DIALOG_ID_PHOTO_PICKER:
			...
			builder.setItems(R.array.photo_picker_ways, dlistener);
